...
|---|---|
| `<example-linear-key-48hex>` | `<REDACTED:linear-api-key:lin_a...0456:48ch>` |
| `<example-mailchimp-key-32hex-us6>` | `<REDACTED:mailchimp-api-key:22eb...-us6:36ch>` |
| `<example-github-pat-40char>` | `<REDACTED:github-pat:ghp_a...tu90:40ch>` |
